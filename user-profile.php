...
<div class="col-md-10 mb-3" >
                    ...
                    <div class="col-md-12 form-group mb-3">
                        <div class="row">
                            ...
                            <a class="btn btn-lg bg-custom text-white" href="edit-change-password.php">Change Password</a>
                            </div>
                            <div class="col-md-6 text-end">
                            <a class="btn btn-lg bg-custom text-white" href="edit-user-info.php">Update Profile</a>
                            </div>
                        </div>
