<div id="layoutSidenav_nav">
                <nav class="sb-sidenav accordion sb-sidenav-dark bg-custom " id="sidenavAccordion">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link text-white" href="#">Export Message</a>
                            ...
                            <div class="collapse" id="collapseCredentials" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                <a class="nav-link text-white" href="#">Accounts & Credentials</a>
                            ...
                            <div class="collapse" id="collapseBills" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
